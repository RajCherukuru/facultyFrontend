...
const CreateAssignmentPage = () => {
    ...
    // };
      ...
      function handleSubmit(event){
        ...
        axios.post(createassignment_api, {name, currentRank, startingAsu, teaching, research, service, studentEvaluation, course, teachingStudentMentor, 
