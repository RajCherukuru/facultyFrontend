...
import { createsabbatical_api, filter_faculty_api } from "../../services/apis";



const CreateSabbaticalPage = () => {
    ...
    // };
      ...
      function handleSubmit(event){
        ...
        axios.post(createsabbatical_api, {name,  startDate,
        endDate,
        currentRank} )
...
export default CreateSabbaticalPage;
